...
import org.lecturestudio.web.service.restrict.RestrictedAccessException;

@Provider
@ApplicationScoped
public class RestrictedExceptionHandler implements ExceptionMapper<RestrictedAccessException> {

	@Override
	@Produces({MediaType.APPLICATION_JSON})
	public Response toResponse(RestrictedAccessException exception) {
