 ...
 * @author Alex Andres
 */
public class RtpDecodeException extends Exception {

	private static final long serialVersionUID = 1672355613402433016L;
	 ...
	 */
	public RtpDecodeException(String message) {
		super(message);
	}
	 ...
	 */
	public RtpDecodeException(String message, Throwable cause) {
        super(message, cause);
    }
