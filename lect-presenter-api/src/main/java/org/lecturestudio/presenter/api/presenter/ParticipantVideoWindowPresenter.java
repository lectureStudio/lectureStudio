...
public class ParticipantVideoWindowPresenter extends Presenter<ParticipantVideoWindow> {

	@Inject
	ParticipantVideoWindowPresenter(ApplicationContext context, ParticipantVideoWindow view) {
		super(context, view);
	}
	...
	public void initialize() {
		...
		view.setTitle(context.getDictionary().get("participant.video.window.title"));
