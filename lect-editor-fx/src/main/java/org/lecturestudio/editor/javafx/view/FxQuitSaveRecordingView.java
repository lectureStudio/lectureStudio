...
@FxmlView(name = "quit-save-recording")
public class FxQuitSaveRecordingView extends NotificationPane implements QuitSaveRecordingView {
	...
	@Inject
	public FxQuitSaveRecordingView(ResourceBundle resources) {
		super(resources);
	}
