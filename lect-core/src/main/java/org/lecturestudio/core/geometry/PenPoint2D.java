...
/**
 * A geometric point that represents the x, y coordinates with pressure
 * sensitivity generated by stylus pens.
 *
 * @author Alex Andres
 */
public class PenPoint2D extends Point2D {
	...
	/**
	 * Create a new instance of {@code PenPoint2D} with origin coordinates and
	 * maximum pressure of 1.
	 */
	public PenPoint2D() {
		super();
	}
	...
	/**
	 * Copy constructor of {@code PenPoint2D} that copies the values of the
	 * specified point.
	 *
	 * @param point The PenPoint2D to copy.
	 */
	...
	/**
	 * Creates a new instance of {@code PenPoint2D} with specified coordinates.
	 *
	...
	/**
	 * Creates a new instance of {@code PenPoint2D} with specified coordinates
	 * and pressure. The pressure must be in the range of [0,1].
	 *
	 * @param x        The x coordinate of the point.
	 * @param y        The y coordinate of the point.
	...
	/**
	 * Set the pressure applied at this point. The value must be in the range of
	 * [0,1].
	 *
