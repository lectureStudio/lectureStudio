...
public class PresenterFxApplication extends JavaFxApplication {
	...
	public static void main(String[] args) {
		...
		PresenterFxApplication.launch(args, PresenterFxPreloader.class);
	}

	@Override
	public ApplicationFactory createApplicationFactory() {
		return new PresenterFxFactory();
	}
}
