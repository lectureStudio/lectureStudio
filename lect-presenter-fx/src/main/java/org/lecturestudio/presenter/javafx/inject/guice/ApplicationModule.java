...
import org.lecturestudio.presenter.javafx.view.FxPresentationViewFactory;
...
public class ApplicationModule extends AbstractModule {
	...
	private static final AppDataLocator LOCATOR = new AppDataLocator("lecturePresenterFX");
	...
	PresentationController createPresentationController(ApplicationContext context) {
		DisplayService displayService = new FxDisplayService();
		PresentationViewFactory viewFactory = new FxPresentationViewFactory();
