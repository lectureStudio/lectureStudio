...
public class ToolExecuteAction extends PlaybackAction implements LocationModifiable {

	private PenPoint2D point;


	public ToolExecuteAction(PenPoint2D point) {
		this.point = point;
	}

	public ToolExecuteAction(byte[] input) throws IOException {
		parseFrom(input);
	}
