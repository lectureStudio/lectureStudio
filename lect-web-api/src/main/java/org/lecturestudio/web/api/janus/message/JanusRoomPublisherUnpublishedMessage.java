 ...
 * @author Alex Andres
 */
public class JanusRoomPublisherUnpublishedMessage extends JanusRoomMessage {
	...
	/**
	 * Create a new {@code JanusRoomPublisherUnpublishedMessage}.
	 *
	 * @param sessionId   The unique integer session ID.
	 * @param roomId      The unique numeric room ID.
	 * @param publisherId The unique publisher ID who unpublished streams in the
	 *                    room.
	 */
	public JanusRoomPublisherUnpublishedMessage(BigInteger sessionId,
	...
	/**
	 * Get the unique publisher ID who unpublished streams in the room.
	 *
