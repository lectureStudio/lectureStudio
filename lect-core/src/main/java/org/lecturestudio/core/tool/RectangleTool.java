...
import org.lecturestudio.core.recording.action.RectangleAction;
 ...
 * @author Alex Andres
 */
public class RectangleTool extends FormTool {

	public RectangleTool(ToolContext context) {
		super(context);
	}
	...
	protected FormShape createShape() {
		return new RectangleShape(createStroke());
	}
