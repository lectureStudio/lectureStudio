...
import org.lecturestudio.presenter.api.net.webrtc.codec.JsonBCodec;
import org.lecturestudio.presenter.api.net.webrtc.config.Configuration;
import org.lecturestudio.presenter.api.net.webrtc.config.VideoConfiguration;

public class PeerConnectionClient implements PeerConnectionObserver {

	private final static Logger LOGGER = System.getLogger(PeerConnectionClient.class.getName());
