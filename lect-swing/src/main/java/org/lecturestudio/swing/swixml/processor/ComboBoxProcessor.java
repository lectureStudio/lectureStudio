...
public class ComboBoxProcessor implements TagProcessor, LogAware {
	...
	public boolean process(Parser parser, Object parent, Element child,
		...
		final ListCellRenderer<Object> renderer = (ListCellRenderer<Object>) rendererClass.getDeclaredConstructor().newInstance();
