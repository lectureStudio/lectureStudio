...
import org.lecturestudio.swing.swixml.factory.*;
...
public class ViewLoader<T extends Container> extends SwingEngine<T> {
	...
	public ViewLoader(T client, ResourceBundle resourceBundle, Injector injector) {
		...
		tagLibrary.registerTag("Menuitem", new AbstractButtonFactory(JMenuItem.class));
		tagLibrary.registerTag("CheckBoxMenuItem", new AbstractButtonFactory(JCheckBoxMenuItem.class));
		tagLibrary.registerTag("RadioButtonMenuItem", new AbstractButtonFactory(JRadioButtonMenuItem.class));
