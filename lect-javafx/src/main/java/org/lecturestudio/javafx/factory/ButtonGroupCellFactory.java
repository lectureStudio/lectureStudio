...
public class ButtonGroupCellFactory implements Callback<TableColumn<Object, Boolean>, TableCell<Object, Boolean>> {

	private final ObservableList<ButtonBase> buttons;


	public ButtonGroupCellFactory(@NamedArg("buttons") ObservableList<ButtonBase> buttons) {
	...
	private class ButtonCell extends TableCell<Object, Boolean> {
		...
		ButtonCell() {
			...
			for (ButtonBase button : buttons) {
				ButtonBase cellButton = cloneButton(button);

				buttonGroup.getButtons().add(cellButton);
			}
		}
		...
		private ButtonBase cloneButton(ButtonBase button) {
			ButtonBase cellButton;
